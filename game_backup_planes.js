...
const PLANE_CONFIGS = [
  { 
    id: 'basic', name: '����ս��', icon: '??', hp: 100, damage: 10, speed: 6, cost: 0, description: '��׼ս������������',
    visual: {
      colors: { body: '#e0e0e0', bodyDark: '#a0a0a0', bodyLight: '#f5f5f5', accent: '#e53935', accentLight: '#ff6b6b', cockpit: '#4fc3f7', cockpitGlow: '#81d4fa', engine: '#616161', engineGlow: '#4fc3f7', wing: '#bdbdbd', wingDark: '#9e9e9e', flame: ['#44aaff', '#66ccff', '#88ddff', '#aaaaff'] },
      shape: { wingSpan: 48, wingSweep: 15, noseLength: 26, bodyWidth: 32, bodyHeight: 56, engineCount: 2, engineSpacing: 46, engineSize: 7, tailStyle: 'standard', tailHeight: 7 },
      decorations: ['topStripe', 'sideStripes', 'wingAccents', 'levelIndicators'],
      glowEffect: 'none'
    }
  },
  { 
    id: 'fast', name: '����ս��', icon: '?', hp: 70, damage: 8, speed: 9, cost: 500, description: '���ٻ��������ܵ���',
    visual: {
      colors: { body: '#fff59d', bodyDark: '#ffb300', bodyLight: '#fffde7', accent: '#0288d1', accentLight: '#4fc3f7', cockpit: '#80deea', cockpitGlow: '#e0f7fa', engine: '#ffca28', engineGlow: '#ffeb3b', wing: '#ffd54f', wingDark: '#ffb300', flame: ['#0288d1', '#03a9f4', '#4fc3f7', '#81d4fa'] },
      shape: { wingSpan: 52, wingSweep: 22, noseLength: 30, bodyWidth: 26, bodyHeight: 52, engineCount: 2, engineSpacing: 42, engineSize: 6, tailStyle: 'swept', tailHeight: 5 },
      decorations: ['lightningStripes', 'wingtips', 'levelIndicators'],
      glowEffect: 'electric'
    }
  },
  { 
    id: 'heavy', name: '����ս��', icon: '???', hp: 150, damage: 15, speed: 4, cost: 800, description: '��Ѫ������װ����',
    visual: {
      colors: { body: '#4caf50', bodyDark: '#2e7d32', bodyLight: '#81c784', accent: '#ff5722', accentLight: '#ff8a65', cockpit: '#66bb6a', cockpitGlow: '#a5d6a7', engine: '#388e3c', engineGlow: '#66bb6a', wing: '#388e3c', wingDark: '#1b5e20', flame: ['#ff5722', '#ff7043', '#ff8a65', '#ffab91'] },
      shape: { wingSpan: 56, wingSweep: 12, noseLength: 22, bodyWidth: 40, bodyHeight: 60, engineCount: 4, engineSpacing: 28, engineSize: 8, tailStyle: 'bulky', tailHeight: 8 },
      decorations: ['armorPlates', 'shieldSymbols', 'levelIndicators'],
      glowEffect: 'shield'
    }
  },
  { 
    id: 'sniper', name: '�ѻ�ս��', icon: '??', hp: 80, damage: 25, speed: 5, cost: 1200, description: '���˺���һ����ɱ',
    visual: {
      colors: { body: '#ce93d8', bodyDark: '#7b1fa2', bodyLight: '#e1bee7', accent: '#f48fb1', accentLight: '#f8bbd0', cockpit: '#e1bee7', cockpitGlow: '#f3e5f5', engine: '#9c27b0', engineGlow: '#ce93d8', wing: '#ba68c8', wingDark: '#6a1b9a', flame: ['#9c27b0', '#ba68c8', '#ce93d8', '#e1bee7'] },
      shape: { wingSpan: 44, wingSweep: 20, noseLength: 34, bodyWidth: 24, bodyHeight: 58, engineCount: 2, engineSpacing: 38, engineSize: 5, tailStyle: 'pointed', tailHeight: 10 },
      decorations: ['sniperScope', 'precisionMarks', 'levelIndicators'],
      glowEffect: 'precision'
    }
  },
  { 
    id: 'legendary', name: '����ս��', icon: '???', hp: 200, damage: 30, speed: 7, cost: 3000, description: '��˵ս�����޵�֮ѡ',
    visual: {
      colors: { body: '#ffd700', bodyDark: '#ff8c00', bodyLight: '#fff8e1', accent: '#ff4500', accentLight: '#ff6347', cockpit: '#ffeb3b', cockpitGlow: '#fff9c4', engine: '#ff8c00', engineGlow: '#ffd700', wing: '#ffa500', wingDark: '#ff6600', flame: ['#ff4500', '#ff6347', '#ffa500', '#ffd700'] },
      shape: { wingSpan: 60, wingSweep: 18, noseLength: 32, bodyWidth: 36, bodyHeight: 62, engineCount: 6, engineSpacing: 22, engineSize: 6, tailStyle: 'legendary', tailHeight: 12 },
      decorations: ['goldenRunes', 'thunderEffects', 'levelIndicators', 'aura'],
      glowEffect: 'legendary'
    }
  }
]
...
const POWERUP_CONFIGS = [
  ...
  { type: 'shield', icon: '🛡�?, color: '#22c55e', effect: 'activateShield', value: 30 },
...
const LEVEL_CONFIGS = [
  ...
  { level: 9, name: '最终防�?, waves: 7, enemies: ['scout', 'fighter', 'bomber', 'elite'], boss: 'boss3' },
...
class Player {
  ...
  updateExhaust(dt) {
    ...
    // 主引擎尾焰（机尾中心�?    this.exhaustParticles.push(new EngineParticle(0, 32));
    // 两侧引擎舱尾�?    this.exhaustParticles.push(new EngineParticle(-46, 14));
  ...
  drawEngineFlame(ctx, now) {
    ...
    // 左侧引擎舱尾�?    const sideLen = 8 + Math.random() * 4;
    for (let i = 3; i >= 0; i--) {
  ...
  drawFuselage(ctx, now) {
    ...
    // 7. 绘制武器等级指示�?    const levelSpacing = 4;
    const levelY = 6;
    for (let i = 0; i < 4; i++) {
